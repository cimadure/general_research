...
# 6. 🧱 Tableau MCDA complet + intégration du score de plausibilité métier
...
## 6.1 🎯 Alternatives (méthodes de correction)
...
## 6.2 🎛️ Critères MCDA (dont le score de plausibilité métier)
...
## 6.3 📊 Tableau de décision (valeurs fictives mais réalistes)
...
## 6.4 🔧 Normalisation des critères
...
## 6.5 ⚖️ Pondération des critères
...
## 6.6 🧮 Calcul du score global (somme pondérée)
...
## 6.8 🎯 Rôle du score de plausibilité métier (C1)
...
# 7. 📚 Monobloc MCDA — ELECTRE, PROMETHEE, TOPSIS, VIKOR, ANP, MULTIMOORA, SLoS, SBWM
...
## 7.2 PROMETHEE (outranking avec fonctions de préférence)
...
## 7.5 ANP (Analytic Network Process)
...
## 7.6 MULTIMOORA (extension de MOORA)
...
## 7.8 SBWM (Stratified Best–Worst Method)
